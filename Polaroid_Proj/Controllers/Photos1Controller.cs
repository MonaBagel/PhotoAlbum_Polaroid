...
namespace Polaroid_Proj.Controllers
{
    public class Photos1Controller : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ImageUrl,AlbumId,GalleryItemId,CapturedDate,UserId,Title,Description")] Photo photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageUrl,AlbumId,GalleryItemId,CapturedDate,UserId,Title,Description")] Photo photo)
        {
